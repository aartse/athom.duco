...
class Co2HumidityValveDevice extends DucoDevice {
  ...
  triggerFlowCards(oldCapabilityValues: DucoBoxCapabilityValues): void {
    ...
    FlowHelper.triggerChangedValueFlowCards(
      ...
      'co2-humidity-valve__ventilation_state_changed'
    );
    ...
    FlowHelper.triggerChangedValueFlowCards(
      ...
      'co2-humidity-valve__ventilation_time_state_remain_changed'
    );
    ...
    FlowHelper.triggerChangedValueFlowCards(
      ...
      'co2-humidity-valve__ventilation_time_state_end_changed'
    );
    ...
    FlowHelper.triggerChangedValueFlowCards(
      ...
      'co2-humidity-valve__ventilation_mode_changed'
    );
    ...
    FlowHelper.triggerChangedValueFlowCards(
      ...
      'co2-humidity-valve__ventilation_flow_level_target_changed'
    );
...
module.exports = Co2HumidityValveDevice;
