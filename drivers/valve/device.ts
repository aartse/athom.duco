...
class ValveDevice extends DucoDevice {
  ...
  triggerFlowCards(oldCapabilityValues: DucoBoxCapabilityValues): void {
    ...
    FlowHelper.triggerChangedValueFlowCards(
      ...
      'valve__ventilation_state_changed'
    );
    ...
    FlowHelper.triggerChangedValueFlowCards(
      ...
      'valve__ventilation_time_state_remain_changed'
    );
    ...
    FlowHelper.triggerChangedValueFlowCards(
      ...
      'valve__ventilation_time_state_end_changed'
    );
    ...
    FlowHelper.triggerChangedValueFlowCards(
      ...
      'valve__ventilation_mode_changed'
    );
    ...
    FlowHelper.triggerChangedValueFlowCards(
      ...
      'valve__ventilation_flow_level_target_changed'
    );
  }
}
